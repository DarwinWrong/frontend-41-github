...
const rules = [
    new Rule("username", "Має бути від 5 до 15 літер", (value) => /^[a-zA-Z]{5,15}$/.test(value)),
    new Rule("birthyear", "Рік від 1900 до поточного", (value) => {
        const year = Number(value);
        const currentYear = new Date().getFullYear()
        return year >= 1900 && year <= currentYear
    }),
    new Rule("eyeColor", "Оберіть колір очей", (value) => ["brown", "green", "gray", "blue"].includes(value)),
  new Rule("hairColor", "Оберіть колір волосся", (value) => ["black", "brown", "white", "red", "other"].includes(value)),
